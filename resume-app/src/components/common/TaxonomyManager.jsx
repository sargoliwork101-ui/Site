/**
 * ═══════════════════════════════════════════════════════════════════
 * TaxonomyManager.jsx — مدیریت گزینه‌های دراپ‌دان سراسری (۴ کارت)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ ۴ لیست: دسته بردها، دسته مقالات، وضعیت‌ها، نرم‌افزارهای EDA.
 * هر کارت افزودن/تغییرنام/حذف داره؛ تغییرنام بلافاصله و آبشاری روی همه
 * بردهای مرتبط اعمال می‌شه (updateTaxonomyOption در DataContext). حذف با
 * دیالوگ تاییده. focusId برای اسکرول از فرم‌ها به کارت مربوطه‌ست.
 * ⚠️ id گزینه جدید خودکار ساخته می‌شه (uniqueId) — دستی وارد نکن.
 */
