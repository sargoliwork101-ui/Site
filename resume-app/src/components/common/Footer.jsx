/**
 * ═══════════════════════════════════════════════════════════════════
 * Footer.jsx — فوتر سایت (برند + لینک سکشن‌ها + ابزارها + کپی‌رایت)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ ستون معرفی با آیکون‌های گیت‌هاب/لینکدین/تلگرام (از personalInfo،
 * با sanitizeUrl)، ستون لینک سکشن‌های فعال (quickLinks — فقط سکشن‌های
 * غیرخالی، قانون ۵)، ستون ابزارها (وبلاگ/جستجو/PDF/ورود ادمین)، و کپی‌رایت
 * با سال خودکار. قفل ورود ادمین هم این‌جاست (دکمه پنل مدیریت).
 */
