/**
 * ═══════════════════════════════════════════════════════════════════
 * ActionDialogModal.jsx — دیالوگ تایید/هشدار سراسری (جایگزین confirm)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ فقط «نمایش» دیالوگه؛ نمایشش با showConfirmDialog /
 * showAlertDialog از DataContext کنترل می‌شه. ۶ تایپ داره (danger/warning/
 * error/success/info/confirm)، با ESC و کلیک بیرون بسته می‌شه.
 * ⚠️ هیچ‌وقت window.confirm/alert جدید نساز — همه تاییدها باید از این‌جا
 * بگذرن (قانون چنداجنتی). این کامپوننت رو مستقیم رندر نکن؛ stateـش دست
 * DataContextـه و در App.jsx یک‌بار سوار شده.
 */
/**
 * ============================================================================
