/**
 * ═══════════════════════════════════════════════════════════════════
 * ExperienceSection.jsx — سوابق شغلی (درخت لینکدین) + تحصیل + گواهی‌ها
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ سه تب (سوابق/تحصیلات/گواهینامه‌ها)، تایم‌لاین شغلی با محاسبه
 * خودکار سنوات، کارت شرکت‌ها با بردهای مرتبط هر شرکت، و مرتب‌سازی زمانی.
 * ⚠️ محاسبه سنوات از روی تاریخ‌هاست — فرمت تاریخ دیتا (YYYY-MM) رو حفظ کن.
 * اگه هر سه لیست خالی باشن سکشن رندر نمی‌شه (قانون ۵).
 */
