/**
 * ═══════════════════════════════════════════════════════════════════
 * ContactSection.jsx — اطلاعات تماس + فرم پیام + دانلود vCard
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ کارت‌های تماس (ایمیل/تلفن/لوکیشن)، فرم ضداسپم (تله honeypot +
 * ریت‌لیمیت ۳ در دقیقه + اعتبارسنجی)، آپلود اختیاری فایل (با هاست: روی
 * سرور؛ بی‌هاست: فقط فایل زیر ۱MB جاسازی می‌شه)، و ارسال ایمیل: اول سرور
 * خودی، بعد fallback؛ نتیجه صادقانه گزارش می‌شه (صفحه موفقیت فقط وقتی
 * نشون داده می‌شه که واقعاً ارسال شده باشه). دانلود vCard هم این‌جاست.
 * ⚠️ فیلد honeypot (website_bot_trap) رو حذف/تغییرنام نده. پیام‌ها همزمان
 * در صندوق پنل (addMessage) هم ذخیره می‌شن.
 */
