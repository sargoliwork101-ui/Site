/**
 * ═══════════════════════════════════════════════════════════════════
 * BlogPortalPage.jsx — پرتال عمومی وبلاگ (نمای جدا از صفحه اول)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ وقتی currentView بشه 'blog' (آدرس #blog)، این صفحه جای کل
 * صفحه اول می‌شینه: هدر وبلاگ، جستجو + فیلتر دسته، گرید پست‌ها، و حالت
 * مطالعه کامل (selectedBlogPost) با لایک محلی و اشتراک‌گذاری و پادکست.
 * ⚠️ این «نما»ست نه روت جدا — با currentView سوییچ می‌شه. پست صفر = پیام
 * خالی مناسب (نه کرش). شمارش لایک فقط محلی‌ـه (مثل BlogModal).
 */
/**
 * ============================================================================
