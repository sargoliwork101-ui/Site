/**
 * ═══════════════════════════════════════════════════════════════════
 * BlogModal.jsx — مودال مطالعه پست وبلاگ (پیش‌نمایش ادمین + مطالعه کامل)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ جستجو/فیلتر دسته بین پست‌ها، مطالعه متن کامل، لایک ذخیره‌شونده
 * در مرورگر (liked_blog_posts)، اشتراک‌گذاری و پخش صوت (اگه داشته باشه).
 * بازشدن: پیش‌نمایش از پنل وبلاگ (setIsBlogModalOpen)؛ پورتال عمومی جدا در
 * BlogPortalPageـه — این دو، دو ورودی متفاوت به همون دیتا هستن.
 * ⚠️ لایک فقط محلی ذخیره می‌شه (شمارنده سراسری نداریم) — همین رفتار نگه دار.
 */
/**
 * ============================================================================
