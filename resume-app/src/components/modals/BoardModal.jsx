/**
 * ═══════════════════════════════════════════════════════════════════
 * BoardModal.jsx — مودال جزئیات برد (عکس/۳D + جدول مشخصات + دانلودها)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ دو حالت نمایش عکس و سه‌بعدی (اگه stepFileUrl داشته باشه)، جدول
 * اسپک دوزبانه، لینک‌های دیتاشیت/گیت‌هاب (با sanitizeUrl)، و نمایشگر ۳D.
 * با setSelectedBoard باز/بسته می‌شه (null = بسته).
 * ⚠️ حالت View-Only: دانلود فایل STEP برای بازدیدکننده ممنوعه (قانون ۱۳) —
 * دکمه دانلود مدل سه‌بعدی اضافه نکن. مشخصات از خود برد میان، هاردکد نکن.
 */
