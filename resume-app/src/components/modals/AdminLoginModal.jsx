/**
 * ═══════════════════════════════════════════════════════════════════
 * AdminLoginModal.jsx — دروازه ورود: لاگین + ویزارد نصب + بازیابی رمز
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ ماشین‌حالت view با ۶ صفحه: login (ورود + ریت‌لیمیت و شمارش
 * معکوس قفل) / setup (ویزارد اولین نصب: رمز قوی + ایمیل) / setup_otp
 * (تایید ایمیل) / forgot_email → forgot_otp → forgot_new_pass (بازیابی با
 * کد ایمیل) + ریست اضطراری محلی (قفل با سؤالات بازیابی).
 * بالای فرم نشان حالت امن 🔒 / محلی 🖥️ نمایش داده می‌شه (صادقانه).
 * ⚠️ قوانین مقدس: هرگز کد OTP روی صفحه نشون نده (قانون ۱۸)، رمز trim نشه،
 * هیچ‌وقت ورود بدون رمز اضافه نکن، و پیام خطا نگو «کدوم فیلد» غلطه.
 */
/**
 * ============================================================================
