/**
 * ═══════════════════════════════════════════════════════════════════
 * TemplatePickerModal.jsx — انتخابگر ۵۰ قالب + فونت و انیمیشن (فقط ادمین)
 * ═══════════════════════════════════════════════════════════════════
 * چی توشه؟ تب دسته‌ها + جستجو بین قالب‌ها، کارت پیش‌نمایش هر قالب (نقطه
 * رنگ‌ها + شبیه‌سازی مینیاتوری)، اعمال فوری با setTemplate، انتخاب فونت
 * فارسی و تاگل انیمیشن مدار.
 * ⚠️ فقط از داخل پنل باز می‌شه (قانون ۱۲) — هیچ دکمه عمومی بهش وصل نکن.
 */
