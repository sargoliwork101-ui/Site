...
1. **رمز عبور پیش‌فرض پنل مدیریت:** `admin` است.
2. **فعال‌سازی در اولین ورود:** در اولین باری که وارد پنل می‌شوید، سیستم به طور خودکار از شما آدرس ایمیل اختصاصی برای دریافت کدهای تایید بازیابی را می‌خواهد و یک کد تایید ۶ رقمی (OTP) ارسال می‌کند تا مطمئن شود ایمیل فعال است.
3. **فراموشی رمز عبور (Forgot Password):** در صورتی که رمز عبور خود را فراموش کردید، در پنجره ورود روی دکمه «فراموشی رمز عبور؟» کلیک کنید؛ یک کد تایید ۶ رقمی به ایمیل ثبت‌شده شما ارسال می‌شود و پس از وارد کردن آن، می‌توانید رمز عبور جدید تعیین کنید.
4. **تغییر مشخصات امنیتی:** در پنل ادمین (تب «امنیت و رمز عبور»)، در هر لحظه می‌توانید ایمیل بازیابی یا رمز عبور پنل را تغییر دهید.
