...
$checks[] = [
    'name' => 'بازیابی رمز با کد ایمیلی (فراموشی رمز عبور)',
    'ok'   => recovery_email() !== '',
    'val'  => recovery_email() !== ''
        ? 'فعال — کد بازیابی به «' . recovery_email() . '» ارسال می‌شود'
        : 'ایمیل بازیابی ثبت نشده — از صفحه ورود دکمه «فراموشی رمز عبور» یا تنظیمات، ایمیل را ثبت کنید',
];
$checks[] = [
